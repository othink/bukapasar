<?php
    echo "<div class='col-md-6'>
        ...
        $feedlist = new rss('https://members.bukapasar.com/forum.xml'); /* Ubah link feed disini dengan link feed Anda */
        echo $feedlist->display(5,"Forum bukapasar"); /* Angka 7 digunakan untuk menampilkan jumlah artikel */
    echo "</section>";