          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th width='140px' scope='row'>Konsumen / Reseller</th>    <td><select id='id_reseller' class='form-control combobox' name='id_reseller' required>
                                                                                ...
                                                                                $konsumen = $this->db->query("SELECT a.*, b.nama_reseller FROM rb_konsumen a JOIN rb_reseller b ON a.id_konsumen=b.id_konsumen");
                                                                                foreach ($konsumen->result_array() as $row) {
                                                                                  echo "<option value='$row[id_konsumen]'>$row[nama_lengkap] / $row[nama_reseller]</option>";
                                                                                }
                                                                                echo "</select></td></tr>
