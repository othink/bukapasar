<?php 
    echo "<div class='col-md-12'>
              ...
              echo form_open_multipart($this->uri->segment(1).'/background',$attributes); 
                error_reporting(0);
                if ($rows['gambar']=='bukapasar'){
                  $bukapasar = 'checked';
                }elseif ($rows['gambar']=='red'){
                  $red = 'checked';
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                      <tr bgcolor=#8b1b56><td><input name='a' value='bukapasar' type='radio' $bukapasar><b style='color:#fff'> Bukapasar</b> </td></tr>
