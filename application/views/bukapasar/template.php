...
<head>
    ...
    <meta name="author" content="bukapasar.com">
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>template/<?php echo template(); ?>/css/bukapasar.css">
    ...
    <script src="<?php echo base_url(); ?>asset/bukapasar_scripts.js"></script>
    <script>
                ...
                <div class="ps-container">
                    ...
                    <div class="header__center">
                        <form class="ps-form--quick-search" action="<?php echo base_url() ?>produk" method="GET">
                            ...
                            <input class="form-control" name='s' value='<?= $_GET['s']; ?>' type="text" placeholder="Aku mau Belanja..." autocomplete='off' required>
