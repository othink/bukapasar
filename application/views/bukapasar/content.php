        ...
        <div class="ps-container">
            <div class="ps-section__left">
                <div class="ps-carousel--nav-inside owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="0" data-owl-nav="true" data-owl-dots="true" data-owl-item="1" data-owl-item-xs="1" data-owl-item-sm="1" data-owl-item-md="1" data-owl-item-lg="1" data-owl-duration="1000" data-owl-mousedrag="on">
                    <?php 
                        $slide1 = $this->db->query("SELECT * FROM slide ORDER BY id_slide DESC");
                        foreach ($slide1->result_array() as $row) {
                            ...
                            echo "<div class='ps-banner'><a title='$judul' href='".$row['link']."'><img class='preview' loading='lazy' src='$foto_slide' alt='$row[gambar]'></a></div>"; 
                            $no++;
                        }
                    ?>
                </div>
                ...
                <?php 
                    ...
                    foreach($top_kategori->result_array() as $row){
                        if($row[icon_kode] != ""){
                            ...
                            $icon = "<img style='width:62px; height:62px;' src='" . base_url() . "asset/foto_produk/$row[icon_image]'>";
                            echo "<div class='col-xl-2 col-lg-3 col-md-4 col-sm-4 col-3' style='padding-right:10px; padding-left:10px;'>
                                    <div class='ps-block--category' style='padding:30px 10px; border-radius:20px; border:0px solid #d2d2d2; color:#000; margin-bottom:60px;'>
                                        <a style='height:80%                                    ' class='ps-block__overlay' href='".base_url()."produk/kategori/$row[kategori_seo]'>
                                            $icon <p style='font-size:11px; padding-top:5px'>$row[nama_kategori]</p>
                                        </a>
                                    </div>
                                  </div>";
                        }
