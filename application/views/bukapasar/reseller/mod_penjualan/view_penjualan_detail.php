                  ...
                  <?php 
                    ...
                    echo "<tr class='warning'>
                          ...
                          echo "<tr><td colspan='3'>&nbsp;</td></tr><tr>
                            <td><a style=\"color:#fff\" id=\"32\" class=\"ps-btn ps-btn--black ml-3 add-to-cart\" href='".base_url()."members/penjualan'><i class='icon-arrow-left'></i> Kembali ke List Order</a></td>
                            <td></td>
                            <td><b><a class='ps-btn margin-btn' href='".base_url()."members/print_kirim/".$this->uri->segment(3)."' target='_blank'><i class='icon-print'></i> PRINT</a></b></td>
                          </tr>";
                    ?>
                    </tbody>
                  </table>
