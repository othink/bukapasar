              ...
              <?php echo "<form action='".base_url()."produk/selesai_belanja' method='POST'>"; ?>
                ...
                $kon = $this->db->query("SELECT * FROM rb_konsumen where id_konsumen='".$this->session->id_konsumen."'")->row_array();
                  echo "<div class='form-group row' style='margin-bottom:5px'>
                        ...
                        <div class='col-sm-10'>
                            <input type='text' name='nama' class='form-control form-mini' value='".$kon[nama_lengkap]."' autocomplete='off' required>
                        </div>
                        </div>
                        ...
                        <div class='col-sm-10'>
                            <div class='form-row'>
                                <div class='form-group col-md-6' style='margin-bottom:5px'>
                                    <input type='number' name='telpon' class='form-control form-mini' value='".$kon['no_hp']."' autocomplete='off' required>
                                </div>
                            </div>
                        </div>
                        </div>
