      ...
      <div class="ps-block__container">
          ...
          <div class="ps-block__footer">
            ...
            <?php if (config('wa_seller')=='Y'){ ?>
              <p>Hubungi kami di : <strong>+<?php echo format_telpon($rows['no_telpon']); ?></strong>atau Klik Tombol Dibawah ini </p><a class="ps-btn ps-btn--fullwidth" target='_BLANK' href="<?php echo "https://api.whatsapp.com/send?phone=".format_telpon($idn['no_telp'])."&amp;text=Hallo%20kak%20$rows[nama_reseller],%20Saya%20Mau%20Bertanya..."; ?>">Hubungi Kami</a>
            <?php } ?>
            </div>
      </div>
  </div>
