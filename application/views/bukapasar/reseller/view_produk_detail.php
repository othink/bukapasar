                ...
                <div class="ps-product__header">
                    ...
                    <div class="ps-product__info">
                        ...
                        <div class="ps-product__meta">
                            ...
                            <?php echo "<p>Stok <b>".($beli['beli']-$jual['jual'])."</b> $record[satuan]</p>"; ?>
                        ...
                        <div class="ps-product__desc">
                            ...
                            <?php 
                                if (config('wa_seller')=='Y'){
                                    echo "<a target='_BLANK' style='text-transform: capitalize; font-size: 9px; background: green; color: #fff; padding: 0px 10px;' class='ps-btn' href='https://api.whatsapp.com/send?phone=".format_telpon($idn['no_telp'])."&amp;text=Hallo%20kak!%20$rows[nama_reseller],%20Saya%20Mau%20Order%20$record[nama_produk]...'><span class='icon-bubbles'></span> Chat Penjual.</a>";
                                }
                            ?>
                            </p>
                            <?php 
