            ...
            <div class="row">
                <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12 ">
                  <?php
                    ...
                    echo form_open_multipart('members/daftar_koperasi',$attributes); 
                ...
                ?>
                    <div class="ps-block--vendor-status biodata">
                        <?php 
                            ...
                            <div class='form-group row' style='margin-bottom:5px'>
                            <label class='col-sm-3 col-form-label' style='margin-bottom:1px'>Nomor KTP</b></label>
                            <div class='col-sm-9'>
                              <input type='text' name='nomor_ktp' class='form-control form-mini' value='$rows[nomor_ktp]' required>
                            </div>
                            </div>
                            ...
                            <div class='form-group row' style='margin-bottom:5px'>
                            <label class='col-sm-3 col-form-label' style='margin-bottom:1px'>Lampiran File Photo KTP</b></label>
                            <div class='col-sm-9'>
