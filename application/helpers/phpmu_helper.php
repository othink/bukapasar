...
function cek_terakhir($datetime, $full = false) {
    ...
    function saldo($id_reseller,$id_konsumen){
        ...
        $pulsas = $ci->db->query("SELECT sum(total) as total FROM rb_pembelian_pulsa WHERE id_konsumen='$id_konsumen'")->row_array();
        ...
        return ((((($penjualan_perusahaan['total']-($tarik['total']+$tarikx['total']))+$deposit['total'])-$pulsa['total']-$pulsas['total'])+$sopir['total'])+$fee['total']+$ongkir['ongkir'])-$kupon['diskon'];
    }
    ...
    function cek_paket_icon($id_reseller){
        ...
        if ($rows['icon_kode']!=''){
            ...
            if($rows['icon_image']=='star1.png'){
                $icon = "<img style='width:20px; margin-right:5px; float:left' src='".base_url()."asset/foto_produk/$rows[icon_image]'>";
            }elseif($rows['icon_image']=='star2.png'){
                $icon = "<img style='width:20px;; float:left' src='".base_url()."asset/foto_produk/star1.png'><img style='width:20px; margin-right:5px; float:left' src='".base_url()."asset/foto_produk/$rows[icon_image]'>";
            }elseif($rows['icon_image']=='star3.png'){
                $icon = "<img style='width:20px; float:left' src='".base_url()."asset/foto_produk/star1.png'><img style='width:20px;float:left' src='".base_url()."asset/foto_produk/star2.png'><img style='width:20px; margin-right:5px; float:left' src='".base_url()."asset/foto_produk/$rows[icon_image]'>";
            }
